...
def gt_pred_lists(gt_class_ids, gt_bboxes, gt_mask, pred_class_ids, pred_bboxes, pred_masks, iou_tresh):
...
def pretty_plot_confusion_matrix(df_cm, annot=True, cmap="Blues", fmt='.2f', fz=11,
    ...
    ax = sn.heatmap(df_cm, annot=annot, annot_kws={"size": fz}, linewidths=lw, ax=ax1,
                    cbar=cbar, cmap=cmap, linecolor='b', fmt=fmt)
...
def plot_confusion_matrix_from_data(y_test, predictions, columns=None, annot=True, cmap="Blues",
      fmt='.2f', fz=11, lw=0.5, cbar=False, figsize=[15,15], show_null_values=0, pred_val_axis='lin'):
    """
